...
plot 'results/memory_3_endorsers/read.dat' u ($1/1000):2 w linespoints ls 2 title 'Memory 50p',\
     '' u ($1/1000):3 w linespoints ls 1 title 'Memory 90p',\
     'results/table_3_endorsers/read.dat' u ($1/1000):2 w linespoints ls 4 title 'Azure Table 50p',\

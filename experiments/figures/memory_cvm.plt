...
set border 3 lw 3
set key at 30, 20 spacing 1 samplen 2 width -2
...
plot 'results/memory_3_endorsers/read.dat' u ($1/1000):2 w linespoints ls 2 title 'Read 50p',\
     '' u ($1/1000):3 w linespoints ls 1 title 'Read 90p',\
     'results/memory_3_endorsers/increment.dat' u ($1/1000):2 w linespoints ls 6 title 'Append 50p',\
     '' u ($1/1000):3 w linespoints ls 5 title 'Append 90p'
#     'results/memory_3_endorsers/create.dat' u ($1/1000):2 w linespoints ls 4 title 'Create 50p',\
